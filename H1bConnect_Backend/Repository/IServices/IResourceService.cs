...
namespace H1bConnect_Backend.Repository.IServices
{
    public interface IResourceService
    {
        ...
        Task<List<ResourceDetails>> GetResourceByNameAndSkillAsync(string firstName, string lastName, string skill, string userType, int yearOfFiling);  // Find a resource by name and skill
